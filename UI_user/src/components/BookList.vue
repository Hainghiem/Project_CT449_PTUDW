    ...
    <div class="book-item mt-3" v-for="(book, index) in books" :key="book._id">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-8 book-info">
          ...
          <p><strong>Nhà cung cấp:</strong> {{ book.publisherAddress }}</p>
        </div>
      </div>

      <!-- Bảng chi tiết sách theo chiều dọc -->
      <div class="book-details border border-2 border-dark mt-3">
        <div
          ...
          <div class="detail-row">
            <div class="action-buttons">
              <button
                ...
                @click="borrowBook(detail._id, book.name)"
                class="borrow-button"
                title="Mượn sách"
              >
                Mượn
...
.action-buttons button {
  ...
  border: none;
  color: #00b4d8; /* Màu cho trạng thái mượn */
  cursor: pointer;
  font-size: 16px;
  font-weight: bold;
}
...
.action-buttons .return-button {
  color: #d22f2f; /* Màu cho trạng thái trả */
}
