...
exports.borrow = async (req, res, next) => {
  try {
    ...
    return next(new ApiError(500, "Lỗi khi cho mượn sách"));
  }
};
...
exports.return = async (req, res, next) => {
  try {
    ...
    return next(new ApiError(500, "Lỗi khi hoàn trả sách"));
  }
};
...
exports.findDetail = async (req, res, next) => {
  try {
    ...
    return next(new ApiError(500, "Lỗi khi tìm sách để mượn"));
  }
};
...
exports.deleteDetail = async (req, res, next) => {
  try {
    ...
    return next(new ApiError(500, `Lỗi khi xóa sách mượn`));
  }
};
