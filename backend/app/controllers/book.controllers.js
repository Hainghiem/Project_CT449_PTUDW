...
exports.create = async (req, res, next) => {
  ...
  try {
    ...
    return next(new ApiError(500, "Lỗi xảy ra tạo book"));
  }
};
...
exports.findAll = async (req, res, next) => {
  ...
  try {
    ...
    return next(new ApiError(500, "Xảy ra lỗi khi truy xuất danh mục sách"));
  }
...
exports.findOne = async (req, res, next) => {
  try {
    ...
    return next(
      new ApiError(500, `Lỗi không tìm thấy sách có id=${req.params.id}`)
    );
  }
};
...
exports.deleteAll = async (req, res, next) => {
  try {
    ...
    return next(new ApiError(500, `Lỗi khi xóa`));
  }
};
...
exports.findAllAvailable = async (req, res, next) => {
  try {
    ...
    return next(new ApiError(500, `Lỗi xảy ra khi tìm sách có thể mượn`));
  }
};
